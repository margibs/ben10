 ...
 -->
                        <div class="panel panel-default divcenter noradius noborder" style="max-width: 400px;">
                            <div class="panel-body" style="padding: 40px;">
                                 <form method="POST" action="{{ url('register') }}" class="nobottommargin">
                                    {!! csrf_field() !!}

                                    <h3 style="margin-bottom: 10px;font-size: 33px;color: #000;font-family: Oswald;"> Register an Account </h3>

                                    <div class="col_full" style="margin-bottom: 10px;">
                                        <label for="login-form-username">Name:</label>
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control not-dark" style="font-size: 25px;height: 40px;    border: 1px solid #cccccc;" />
                                    </div>
                                    ...
                                    <div class="col_full">
                                        ...
                                        <input type="password" id="login-form-password" name="password_confirmation" value="" class="form-control not-dark"  style="font-size: 25px;height: 40px;"/>
                                    </div>

                                    <div class="col_full nobottommargin">
                                        <button class="button button-3d button-black nomargin" id="login-form-submit" name="login-form-submit" value="Submit">Submit</button>                                        
                                    </div>
                                </form>
